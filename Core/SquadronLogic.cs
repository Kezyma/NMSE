...
internal static class SquadronLogic
{
    ...
    internal static readonly Dictionary<string, string> ShipResourceToType = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "MODELS/COMMON/SPACECRAFT/FIGHTERS/RASAMAMAGOLD.SCENE.MBIN", "Golden Rasamama S36" },
        { "MODELS/COMMON/SPACECRAFT/FIGHTERS/VINTAGEINTERCEPTOR.SCENE.MBIN", "Vintage Interceptor" },
    };
    ...
    internal static readonly Dictionary<string, string> ShipTypeToResource = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        { "Golden Rasamama S36", "MODELS/COMMON/SPACECRAFT/FIGHTERS/RASAMAMAGOLD.SCENE.MBIN" },
        { "Vintage Interceptor", "MODELS/COMMON/SPACECRAFT/FIGHTERS/VINTAGEINTERCEPTOR.SCENE.MBIN" },
    };
